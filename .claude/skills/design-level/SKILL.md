...
5. Before adding a dish piece, call `get_valid_dish_pieces`. After changing customers, dishes, yields, or queue contents, call `get_supply_demand` and reconcile exact `have`/`need`.
