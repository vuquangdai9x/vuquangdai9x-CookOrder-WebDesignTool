...
const VIETNAMESE: Record<string, string> = {
  ...
  "Check Solvable": "Kiểm tra khả năng thắng",
  "Replay Solvable": "Xem lại kiểm tra thắng",
  "Solvability Check Replay": "Xem lại kiểm tra khả năng thắng",
  ...
  "Packing mode behavior": "Cách đóng gói nguyên liệu",
  "Packing raw": "Nguyên liệu đóng gói",
  "Unpacked raw": "Nguyên liệu rời",
  "Tool process behavior": "Cách dụng cụ xử lý",
  "Wait-order": "Chờ đơn hàng",
  ...
  "Run Estimate Difficulty or Check Solvable in the config panel first": "Hãy chạy Ước tính độ khó hoặc Kiểm tra khả năng thắng trong bảng cấu hình trước",
