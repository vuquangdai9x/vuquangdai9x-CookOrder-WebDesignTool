  ...
  async readAuthoringContext(mapId: string): Promise<Record<string, unknown>> {
    ...
    return {
      ...
      queueRules: {
        ...
        amountIsAtomicUnpackedRelease: true,
        amountExpandsToIndependentOneUseItems: true,
        multipleUsageDoesNotCreateReusableRuntimeObject: true,
        atMostOneExpandedItemMayEnterAnAvailableToolDirectly: true,
        everyRemainderRequiresDistinctGridCell: true,
        insufficientDestinationsBlockWholePick: true,
        generatedAmountTargetsStayWithinPickupableStackRange: true,
      },
